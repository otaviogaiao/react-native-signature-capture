...
public class RSSignatureCaptureViewManager extends ViewGroupManager<RSSignatureCaptureMainView> {
	...
	public static final String PROPS_MAX_IMAGE_MIRROR="imageMirror";
	...
	@ReactProp(name = PROPS_MAX_IMAGE_MIRROR)
	public void setImageMirror(RSSignatureCaptureMainView view, @Nullable Boolean imageMirror) {
		Log.d("setImageMirror:", "" + imageMirror);
		if(view!=null){
			view.setImageMirror(imageMirror);
		}
	}
